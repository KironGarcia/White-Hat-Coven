...
- **Push:** sempre que Kiron pedir push / git push / subir ao GitHub, **acionar a skill `gitpush`** (`.cursor/skills/gitpush/SKILL.md`) antes de commitar. Nunca a linha `Co-authored-by: Cursor`. Nunca ZIM nem doc de desenvolvimento no remoto — só o jogo.
